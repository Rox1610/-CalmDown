...
Resource.create(category: 0, content: "https://www.youtube.com/embed/KLMhVJlOb3E", description: "Take a place confortably and relax by watching the aquarium",profile: profile_visuel, name: "aquarium")
