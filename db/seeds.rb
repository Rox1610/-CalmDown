...
Resource.create(category: 0, content: "https://www.youtube.com/embed/KLMhVJlOb3E", description: "Take a place confortably and relax by watching the aquarium",profile: profile_visuel)
Resource.create(category: 0, content: "https://www.youtube.com/embed/G-9_ndX5mgQ", description: "Take a place confortably and relax by watching the clean mountain river", profile: profile_visuel)
Resource.create(category: 0, content: "https://www.youtube.com/embed/DcN9LtgFuas", description: "Take a place confortably and relax by watching the snow forest", profile: profile_visuel)
Resource.create(category: 0, content: "https://www.youtube.com/embed/7Nn7NZI_LN4", description: "Take a place confortably and relax by watching the domino", profile: profile_visuel)
Resource.create(category: 0, content: "https://www.youtube.com/embed/NwtZ9jfK7x8", description: "Take a place confortably and relax by watching the relaxing visual", profile: profile_visuel)

puts "Creation of musics"
Resource.create(category: 1, content: "https://www.mixcloud.com/widget/iframe/?hide_cover=1&mini=1&feed=%2Fyogatea%2Frelax-with-nature-dolphins-whales%2F", description: "Take a place confortably and listen to the whale sing from Tadoussac", profile: profile_auditif)
Resource.create(category: 1, content: "https://www.mixcloud.com/widget/iframe/?hide_cover=1&mini=1&feed=%2FOWM%2Frainforest-natural-sounds%2F", description: "Take a place confortably and listen to the sound of the rainforest", profile: profile_auditif)
Resource.create(category: 1, content: "https://www.mixcloud.com/widget/iframe/?hide_cover=1&mini=1&feed=%2Fyogatea%2Frelax-with-nature-woodland-nightfall%2F", description: "Take a place confortably and listen to the nature sounds", profile: profile_auditif)
Resource.create(category: 1, content: "https://www.mixcloud.com/widget/iframe/?hide_cover=1&mini=1&feed=%2FFteraki_Marabou%2Fthe-sound-of-rain-above-my-window%2F", description: "Take a place confortably and listen to the rain sounds", profile: profile_auditif)
